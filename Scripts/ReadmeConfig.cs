...
namespace ReadmeMaker
{
    public class ReadmeConfig
    {
        ...
        public DisplayType DisplayByType => Plugin.Instance.Config.Bind("Cards", "Display By", DisplayType.Table, new ConfigDescription("Changes how the cards, abilities and special abilities are displayed.", null, Array.Empty<object>())).Value;
